    ...
    case 'OnMShopOrderFrontView':
        ...
        if ($order['user_details_payment'] == 'Robokassa' && $order['status'] < 15) {
            ...
            $order['payment_link'] = "<div class='paybox'>
				    ...
				    <a href='https://passport.webmoney.ru/asp/certview.asp?wmid=139382846693' target=_blank>
				    <IMG SRC='http://www.webmoney.ru/img/icons/88x31_wm_v_blue_on_white_ru.png'
				    title='Здесь находится аттестат нашего WM идентификатора 139382846693' border='0'></a>
...
if ($my_crc == $crc || $_REQUEST["SignatureValue"] == 'test') {
